...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName: [iDevicesUtil getAppWideBoldFontName] size:kLabelFontSize];
		self.detailsLabelFont = [UIFont fontWithName: [iDevicesUtil getAppWideBoldFontName] size:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
