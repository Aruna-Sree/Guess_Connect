...
extern NSString * const NXOAuth1ClientConnectionContextTempTokenRequest;
extern NSString * const NXOAuth1ClientConnectionContextTokenRequest;
...
@protected
    ...
    //temporary token
    NSString    * temporaryAccessToken;
    NSString    * temporaryAccessSecret;
...
@property (nonatomic, strong) NSString *temporaryAccessToken;
@property (nonatomic, strong) NSString *temporaryAccessSecret;
