...
+ (id)tokenWithResponseBody:(NSString *)theResponseBody tokenType:(NSString *)tokenType;
{
    ...
    NSString *aSecretToken = [jsonDict objectForKey:@"secret_token"];
...
{
    return [self initWithAccessToken:anAccessToken refreshToken:nil secretToken: nil expiresAt:nil];
}

- (id)initWithAccessToken:(NSString *)anAccessToken andSecretToken: (NSString *) aSecretToken
{
    return [self initWithAccessToken:anAccessToken refreshToken:nil secretToken: aSecretToken expiresAt:nil];
}

- (id)initWithAccessToken:(NSString *)anAccessToken refreshToken:(NSString *)aRefreshToken secretToken: (NSString *) aSecretToken expiresAt:(NSDate *)anExpiryDate;
{
    return [[[self class] alloc] initWithAccessToken:anAccessToken
                                        refreshToken:aRefreshToken
                                         secretToken:aSecretToken
...
- (id)initWithAccessToken:(NSString *)anAccessToken refreshToken:(NSString *)aRefreshToken  secretToken: (NSString *) aSecretToken expiresAt:(NSDate *)anExpiryDate scope:(NSSet *)aScope;
{
    return [[[self class] alloc] initWithAccessToken:anAccessToken
                                        refreshToken:aRefreshToken
                                         secretToken:aSecretToken
...
- (id)initWithAccessToken:(NSString *)anAccessToken refreshToken:(NSString *)aRefreshToken  secretToken: (NSString *) aSecretToken expiresAt:(NSDate *)anExpiryDate scope:(NSSet *)aScope responseBody:(NSString *)aResponseBody;
{
    return [[[self class] alloc] initWithAccessToken:anAccessToken
                                        refreshToken:aRefreshToken
                                         secretToken:aSecretToken
...
- (id)initWithAccessToken:(NSString *)anAccessToken refreshToken:(NSString *)aRefreshToken secretToken: (NSString *) aSecretToken expiresAt:(NSDate *)anExpiryDate scope:(NSSet *)aScope responseBody:(NSString *)aResponseBody tokenType:(NSString *)aTokenType
{
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:secretToken forKey:@"secretToken"];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        secretToken = [[aDecoder decodeObjectForKey:@"secretToken"] copy];
