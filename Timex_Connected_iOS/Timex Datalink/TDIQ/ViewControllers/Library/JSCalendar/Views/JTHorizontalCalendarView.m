...
- (void)updatePageMode
{
    ...
    NSDateComponents *comp = [gregorian components:(NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay) fromDate:_rightView.date];
    [comp setDay:1];
    NSDate *firstDayOfMonthDate = [gregorian dateFromComponents:comp];
    BOOL haveRightPage = [_manager.delegateManager canDisplayPageWithDate:firstDayOfMonthDate];
